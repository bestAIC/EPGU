      ...
      <div id="header">
        <div class="top">
          <ul class="nav clear">
            <li class="col_1">
              <span class="logo">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="150px" height="34px" viewBox="0 0 221.416 49.583" enable-background="new 0 0 221.416 49.583" xml:space="preserve">
