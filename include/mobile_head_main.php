  ...
  <div id="wrap" class="main">
    ...
    <div class="cover">
      <div id="header">
        <div class="top">
          <ul class="nav clear">
            <li class="col_1">
              <span class="logo">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="221.416px" height="49.583px" viewBox="0 0 221.416 49.583" enable-background="new 0 0 221.416 49.583" xml:space="preserve">
      ...
      <div id="intro">
        <div class="ee"></div>
        <div class="txt">
          <h2>Теперь пользоваться госуслугами очень просто!</h2>
          <p>Мы запустили дополнение к основному порталу. Если вы уже были зарегистрированы, то можете использовать здесь свои логин и пароль.</p>
          <div class="enter_block">
            <a href="#" class="btn"><b>Зарегистрироваться</b></a> <span>или</span> <a href="#" class="enter_link"><b>Войти</b></a>  
          </div>
        </div>
      </div>