        ...
        <form class="main clear">
            ...
            <div class="switcher_n">
                ...
                <fieldset class="group_6">
                    ...
                    <em class="wrapper l_33"><input type="text" placeholder="Дата рождения" class="big" /><i class="not">необязательно</i>
                    </em>
                    ...
                    <em class="wrapper l_100"><input type="radio" name="g_2_v_1" id="с_4_v_1"/><label for="с_4_v_1">Иного государства</label></em>
                    <div class="fields_cover">
                        <em class="wrapper l_100"><input type="text" placeholder="Наименование документа" class="big" /></em>
                    </div>
                </fieldset>
