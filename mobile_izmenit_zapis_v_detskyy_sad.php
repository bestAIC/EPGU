...
$pagetitle = 'Изменить или отменить запись в детский сад';
...
<div id="content">
	<div class="title">
	  <div class="limiter">
	  	<span class="icomoon color_4">Y</span><h1>Изменить или отменить запись в детский сад</h1>
	  </div>
	</div>
	...
	<form action="#" class="main clear big_inp-form bt">             
	  	<fieldset class="group_1">
			<div class="limiter">
				...
				<h3>Заявление № 424134 от 29.08.2014 </h3>
			</div>
		 ...
		 <fieldset class="group_2">
	        ...
	        <div class="limiter">
		      ...
		      </em><em class="wrapper l_50"><label for="i_03">Отчество</label><input id="i_03" type="text" placeholder="Отчество" class="big" disabled="disabled"/></em>
	            <br/>
		      ...
		      </em><em class="wrapper l_25"><input type="radio" name="sex_2" disabled="disabled" /><label>Женский</label></em>
	            <br/>

	            <em class="wrapper l_33"><label for="i_05">СНИЛС</label><input id="i_05" type="text" placeholder="СНИЛС" class="big" value="152-676-184 70" disabled="disabled"/></em>
	            <br/>
	    ...
	    <fieldset class="group_3">
            ...
            <div class="limiter">
                ...
                <div class="info-block_wrap">
                    <div class="info_block type_2">
                        <p class="info-block_h"><b>Обратите внимание</b>
                        </p>
                        <p>Изменение личных данных будет происходить в личном кабинете.</p>
                        <span class="icomoon">"</span>
                    </div>
        ...
        <fieldset class="group_4">
            ...
            <div class="limiter"><em class="wrapper l_100"><input type="radio" name="g_1_1" id="f_13"/><label for="f_13">Иное</label></em>
            </div>
        ...
        <fieldset class="group_5">
	        ...
	        <div class="limiter">
	            <em class="wrapper l_50"><label for="i_14">Фамилия</label><input id="i_14" type="text" placeholder="Фамилия" class="big" />
	              ...
	              </em><em class="wrapper l_50"><label for="i_16">Отчество</label><input id="i_16" type="text" placeholder="Отчество" class="big" /></em>
	            <br/>
	            ...
	            <em class="wrapper l_33"><label for="i_17">Дата рождения</label><input id="i_17" type="text" placeholder="Дата рождения" class="big"  />
	              ...
	              </em><em class="wrapper l_25"><input id="i_19" type="radio" name="sex_4" /><label for="i_19">Женский</label></em>
	            <br/>
       ...
       <fieldset class="group_7">
           <div class="limiter">
               ...
               <h3>Адрес регистрации ребёнка</h3>
           </div>
       ...
       <fieldset class="group_9">
           ...
           <div class="limiter">
               <em class="wrapper l_33">Отображать по:
                 ...
                 </em><em class="wrapper l_33"><input type="radio" name="g_4" id="f_20"/><label for="f_20">месту проживания</label></em>
               <br/>
                   ...
                   <div class="map_nav">
                       ...
                       <ul class="map_list">
                           <li class="map_list_item">
                               ...
                               <div>
                                   <p><span class="pseudo">Детский сад №2293</span>
                                   </p>
                           ...
                           <li class="map_list_item">
                               ...
                               <div>
                                   <p><span class="pseudo">Детский сад №2285</span>
                                   </p>
                           ...
                           <li class="map_list_item">
                               ...
                               <div>
                                   <p><span class="pseudo">Детский сад №1732</span>
                                   </p>
                           ...
                           <li class="map_list_item">
                               ...
                               <div>
                                   <p><span class="pseudo">Детский сад №1952</span>
                                   </p>
                           ...
                           <li class="map_list_item">
                               ...
                               <div>
                                   <p><span class="pseudo">Детский сад №1977</span>
                                   </p>
               ...
               <div class="map_ballon_block">
                   <div class="map_ballon_wrap">
                       ...
                       <div class="map_ballon_h">
                           <p><strong>Детский сад №2285</strong>
                           </p>
                       </div>
