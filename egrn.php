        ...
        <form class="main clear">
          ...
          <div class="switcher_n"> 
            ...
            <fieldset class="group_3">                   
              ...
              <em class="wrapper l_25"><input type="text" placeholder="Дата рождения" class="big"  disabled="disabled"/>
              </em><em class="wrapper l_16"><input type="radio" name="sex_2_2" disabled="disabled" checked="checked" /><label>Мужской</label>
              </em><em class="wrapper l_16"><input type="radio" name="sex_2_2" disabled="disabled" /><label>Женский</label></em><br/>            
