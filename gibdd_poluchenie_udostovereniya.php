<?
$pagename = 'gibdd_poluchenie_udostovereniya';
$pagetitle = 'Получение водительского удостоверения :: Получение права на управление транспортным средством';
...
?>
	...
	<div id="content">
		<div class="title">
			...
			<span class="icomoon color_1">^</span><h1>Получение водительского удостоверения</h1>		
		</div>
		...
		<form class="main clear" action="zamena_psporta_pol_ok.php">
			...
			<h2 class="group_title">Сведения о подготовке и медицинской справке</h2>
			...
			<fieldset class="group_5">
				...
				<h3>Сведения об автошколе</h3>
				<h4>Укажите название автошколы и сведения о сертификате о её окончании</h4>					
				<em class="wrapper l_100"><input type="text" placeholder="Название автошколы" class="big"/></em>

				<em class="wrapper l_33"><input type="text" placeholder="Номер сертификата" class="big" />
				</em><em class="wrapper l_25"><input type="text" placeholder="Дата выдачи" class="big" /></em><br/>
				
				<h4>Хотели бы вы указать номер лицензии автошколы?</h4>

				<em class="wrapper l_100"><input type="radio" name="g_22_1" id="f_3_1" /><label for="f_3_1">Да</label></em>
				<div class="fields_cover">
				  <em class="wrapper l_33"><input type="text" placeholder="Регистрационный номер" class="big" />
				...
				<em class="wrapper l_100"><input type="radio" name="g_22_1" id="f_4_1" checked="checked" /><label for="f_4_1">Нет</label></em>  
			</fieldset>
